...
public class CallDecorator<T> {
    ...
    public CallDecorator<T> setOnResponse(OnServerResponseSucceedWithStatusCode<T> onServiceInteractionSuccessWithStatusCode) {
        this.onServiceInteractionSuccessWithStatusCode = onServiceInteractionSuccessWithStatusCode;
        return this;
    }

    public CallDecorator<T> setOnFail(OnServerResponseFail onServiceInteractionFail) {
